...
landSurfaceSpeed = 0.4;
riverSurfaceSpeed = 0.5;
landSubsurfaceSpeed = 0.05;
riverSubsurfaceSpeed  = 0.05;
returnLandFlow = 0.005;
returnRiverFlow = 0.005;
maxStorageDepth = 0.14;
drainStorageRate = 0.00005;
